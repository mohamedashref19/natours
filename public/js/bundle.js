...
var displaymap = exports.displaymap = function displaymap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibW9oYW1lZGFzaHJlZiIsImEiOiJjbWhkaDluYmMwMmdxMm5zOGk4cjhxano3In0.vWXNGwZC9SK6YphWKp_r4g ';
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        ...
        case 2:
          _context2.p = 2;
          _t2 = _context2.v;
          (0, _alert.showAlert)('error', 'some thing is worng try again later');
        case 3:
...
var signup = exports.signup = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(email, name, password, passwordconfirm) {
    var res, _t3;
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.p = _context3.n) {
        ...
        case 1:
          res = _context3.v;
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Validation email sent! Please check your inbox.');
            window.setTimeout(function () {
              location.assign('/');
            }, 1500);
          }
...
var updateSettings = exports.updateSettings = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(data, type) {
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          url = type === 'password' ? 'http://127.0.0.1:3000/api/v1/users/updatepassword' : 'http://127.0.0.1:3000/api/v1/users/updatemyDate';
          _context.p = 1;
          _context.n = 2;
          return (0, _axios.default)({
            method: 'PATCH',
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } /* eslint-disable */
var tourbook = exports.tourbook = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(tourid, dateId) {
    var stripe, session, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          stripe = Stripe('pk_test_51SUqhpCEsT2n5ixkKhJbBopDmx0PfSjZ7ewiKNZL29WXB9GZebFQHFbwwekVJYBFL81w0Hx65kE9XSSAMvdAzZ9n00wlKYE7tj');
          _context.p = 1;
          _context.n = 2;
          return (0, _axios.default)({
            method: 'GET',
            url: "http://127.0.0.1:3000/api/v1/bookings/checkout-session/".concat(tourid, "/").concat(dateId)
          });
        case 2:
          session = _context.v;
          _context.n = 3;
  ...
  return function tourbook(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"submitReview.js":[function(require,module,exports) {
"use strict";
...
var updateReview = exports.updateReview = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(reviewId, review, rating) {
    var res, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
...
exports.updateReviewAdmin = exports.edituser = exports.deleteUser = exports.deleteTour = exports.deleteReviewAdmin = exports.deleteMangebooking = exports.createUser = exports.createTour = exports.EditTour = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alert = require("./alert");
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
function _regenerator() { /*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/babel/babel/blob/main/packages/babel-helpers/LICENSE */ var e, t, r = "function" == typeof Symbol ? Symbol : {}, n = r.iterator || "@@iterator", o = r.toStringTag || "@@toStringTag"; function i(r, n, o, i) { var c = n && n.prototype instanceof Generator ? n : Generator, u = Object.create(c.prototype); return _regeneratorDefine2(u, "_invoke", function (r, n, o) { var i, c, u, f = 0, p = o || [], y = !1, G = { p: 0, n: 0, v: e, a: d, f: d.bind(e, 4), d: function d(t, r) { return i = t, c = 0, u = e, G.n = r, a; } }; function d(r, n) { for (c = r, u = n, t = 0; !y && f && !o && t < p.length; t++) { var o, i = p[t], d = G.p, l = i[2]; r > 3 ? (o = l === n) && (u = i[(c = i[4]) ? 5 : (c = 3, 3)], i[4] = i[5] = e) : i[0] <= d && ((o = r < 2 && d < i[1]) ? (c = 0, G.v = n, G.n = i[1]) : d < l && (o = r < 3 || i[0] > n || n > l) && (i[4] = r, i[5] = n, G.n = l, c = 0)); } if (o || r > 1) return a; throw y = !0, n; } return function (o, p, l) { if (f > 1) throw TypeError("Generator is already running"); for (y && 1 === p && d(p, l), c = p, u = l; (t = c < 2 ? e : u) || !y;) { i || (c ? c < 3 ? (c > 1 && (G.n = -1), d(c, u)) : G.n = u : G.v = u); try { if (f = 2, i) { if (c || (o = "next"), t = i[o]) { if (!(t = t.call(i, u))) throw TypeError("iterator result is not an object"); if (!t.done) return t; u = t.value, c < 2 && (c = 0); } else 1 === c && (t = i.return) && t.call(i), c < 2 && (u = TypeError("The iterator does not provide a '" + o + "' method"), c = 1); i = e; } else if ((t = (y = G.n < 0) ? u : r.call(n, G)) !== a) break; } catch (t) { i = e, c = 1, u = t; } finally { f = 1; } } return { value: t, done: y }; }; }(r, o, i), !0), u; } var a = {}; function Generator() {} function GeneratorFunction() {} function GeneratorFunctionPrototype() {} t = Object.getPrototypeOf; var c = [][n] ? t(t([][n]())) : (_regeneratorDefine2(t = {}, n, function () { return this; }), t), u = GeneratorFunctionPrototype.prototype = Generator.prototype = Object.create(c); function f(e) { return Object.setPrototypeOf ? Object.setPrototypeOf(e, GeneratorFunctionPrototype) : (e.__proto__ = GeneratorFunctionPrototype, _regeneratorDefine2(e, o, "GeneratorFunction")), e.prototype = Object.create(u), e; } return GeneratorFunction.prototype = GeneratorFunctionPrototype, _regeneratorDefine2(u, "constructor", GeneratorFunctionPrototype), _regeneratorDefine2(GeneratorFunctionPrototype, "constructor", GeneratorFunction), GeneratorFunction.displayName = "GeneratorFunction", _regeneratorDefine2(GeneratorFunctionPrototype, o, "GeneratorFunction"), _regeneratorDefine2(u), _regeneratorDefine2(u, o, "Generator"), _regeneratorDefine2(u, n, function () { return this; }), _regeneratorDefine2(u, "toString", function () { return "[object Generator]"; }), (_regenerator = function _regenerator() { return { w: i, m: f }; })(); }
...
var edituser = exports.edituser = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(UserId, data) {
    var res, _t3;
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.p = _context3.n) {
        case 0:
        ...
        case 1:
          ...
          if (res.data.status === 'sucess') {
            (0, _alert.showAlert)('success', 'User Update successfully!');
            window.setTimeout(function () {
              location.reload(true);
            }, 1000);
          }
    ...
    return _regenerator().w(function (_context4) {
      while (1) switch (_context4.p = _context4.n) {
        ...
        case 1:
          res = _context4.v;
          if (res.data.status === 'sucess') {
            (0, _alert.showAlert)('success', 'User Create successfully!');
            window.setTimeout(function () {
              location.reload(true);
            }, 1000);
          }
...
var EditTour = exports.EditTour = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5(TourId, data) {
    var res, _t5;
    return _regenerator().w(function (_context5) {
      while (1) switch (_context5.p = _context5.n) {
        ...
        case 1:
          res = _context5.v;
          if (res.data.status === 'sucess') {
            (0, _alert.showAlert)('success', 'Tour Update successfully!');
            window.setTimeout(function () {
              location.reload(true);
            }, 1000);
          }
  ...
  return function EditTour(_x6, _x7) {
...
var createTour = exports.createTour = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context6) {
      while (1) switch (_context6.p = _context6.n) {
        ...
        case 1:
          res = _context6.v;
          if (res.data.status === 'sucess') {
            (0, _alert.showAlert)('success', 'Tour Create successfully!');
            window.setTimeout(function () {
              location.reload(true);
            }, 1000);
          }
  ...
  return function createTour(_x8) {
    return _ref6.apply(this, arguments);
  };
}();
var updateReviewAdmin = exports.updateReviewAdmin = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee7(reviewId, data) {
    var res, _t7;
    return _regenerator().w(function (_context7) {
      while (1) switch (_context7.p = _context7.n) {
        ...
        case 2:
          _context7.p = 2;
          _t7 = _context7.v;
          (0, _alert.showAlert)('error', _t7.response.data.message);
        case 3:
          return _context7.a(2);
      }
    }, _callee7, null, [[0, 2]]);
  }));
  return function updateReviewAdmin(_x9, _x0) {
    return _ref7.apply(this, arguments);
  };
}();
var deleteReviewAdmin = exports.deleteReviewAdmin = /*#__PURE__*/function () {
  var _ref8 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee8(reviewId) {
    var res, _t8;
    return _regenerator().w(function (_context8) {
      while (1) switch (_context8.p = _context8.n) {
        ...
        case 2:
          _context8.p = 2;
          _t8 = _context8.v;
          (0, _alert.showAlert)('error', _t8.response.data.message);
        case 3:
          return _context8.a(2);
      }
    }, _callee8, null, [[0, 2]]);
  }));
  return function deleteReviewAdmin(_x1) {
    return _ref8.apply(this, arguments);
  };
}();
var deleteMangebooking = exports.deleteMangebooking = /*#__PURE__*/function () {
  var _ref9 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee9(bookingId) {
    var res, _t9;
    return _regenerator().w(function (_context9) {
      while (1) switch (_context9.p = _context9.n) {
        ...
        case 2:
          _context9.p = 2;
          _t9 = _context9.v;
          (0, _alert.showAlert)('error', _t9.response.data.message);
        case 3:
          return _context9.a(2);
      }
    }, _callee9, null, [[0, 2]]);
  }));
  return function deleteMangebooking(_x10) {
...
var editUserForm = document.querySelector('.form--edit-user');
var modal = document.querySelector('.modal');
var closeModalBtn = document.querySelector('.btn--close-modal');
var btnAddUser = document.querySelector('.btn--add-user');
var modalCreateUser = document.querySelector('.modal--create');
var btnCloseModalCreate = document.querySelector('.btn--close-modal-create');
var formCreateUser = document.querySelector('.form--create-user');
var editTourBtns = document.querySelectorAll('.btn--edit-tour');
...
var modalCreateTour = document.querySelector('.modal--create');
if (mapBox) {
...
if (bookbtn) bookbtn.addEventListener('click', function (e) {
  ...
  var _e$target$dataset = e.target.dataset,
    ...
    dateId = _e$target$dataset.dateId;
  (0, _stripe.tourbook)(tourId, dateId);
});
if (reviewForm) {
  reviewForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var tourId = document.getElementById('submit-review').dataset.tourId;
    var rating = document.getElementById('rating').value;
    var review = document.getElementById('review').value;
    (0, _submitReview.submitReview)(tourId, review, rating);
  });
}
if (editButtons) {
  editButtons.forEach(function (btn) {
    btn.addEventListener('click', function (e) {
      ...
      var currentReview = e.target.dataset.reviewText;
      var currentRating = e.target.dataset.reviewRating;
      var newReview = prompt('Update your review:', currentReview);
      var newRating = prompt('Update your rating (1-5):', currentRating);
      if (newReview && newRating) {
        (0, _updateReview.updateReview)(reviewId, newReview, Number(newRating));
      }
    });
  });
}
if (deleteTourBtns) {
  deleteTourBtns.forEach(function (btn) {
    btn.addEventListener('click', function (e) {
  ...
  editUserBtns.forEach(function (btn) {
    btn.addEventListener('click', function (e) {
      ...
      var _e$target$dataset2 = e.target.dataset,
        ...
        userName = _e$target$dataset2.userName,
        userEmail = _e$target$dataset2.userEmail,
        userRole = _e$target$dataset2.userRole;
...
if (formCreateUser) {
  formCreateUser.addEventListener('submit', function (e) {
    ...
    var passwordconfirm = document.getElementById('create-password-confirm').value;
    (0, _admin.createUser)({
      name: name,
      email: email,
      role: role,
...
if (editTourBtns) {
  editTourBtns.forEach(function (btn) {
    btn.addEventListener('click', function (e) {
      e.preventDefault();
      var _e$target$dataset3 = e.target.dataset,
        tourId = _e$target$dataset3.tourId,
        tourName = _e$target$dataset3.tourName,
        tourPrice = _e$target$dataset3.tourPrice,
        tourDifficulty = _e$target$dataset3.tourDifficulty,
        tourDuration = _e$target$dataset3.tourDuration,
        tourGroup = _e$target$dataset3.tourGroup,
        tourSummary = _e$target$dataset3.tourSummary;
...
if (editTourForm) {
  editTourForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var id = document.getElementById('edit-tour-id').value;
    ...
    form.append('duration', document.getElementById('edit-tour-duration').value);
    form.append('maxGroupSize', document.getElementById('edit-tour-group').value);
    form.append('difficulty', document.getElementById('edit-tour-difficulty').value);
    form.append('summary', document.getElementById('edit-tour-summary').value);
    var coverImage = document.getElementById('edit-image-cover').files[0];
    if (coverImage) {
    ...
    (0, _admin.EditTour)(id, form);
  });
}
var btnAddTour = document.querySelector('.btn--add-tour');
if (btnAddTour) {
  btnAddTour.addEventListener('click', function () {
...
if (createTourForm) {
  createTourForm.addEventListener('submit', function (e) {
    ...
    form.append('duration', document.getElementById('create-tour-duration').value);
    form.append('maxGroupSize', document.getElementById('create-tour-group').value);
    form.append('difficulty', document.getElementById('create-tour-difficulty').value);
    form.append('summary', document.getElementById('create-tour-summary').value);
    ...
    form.append('description', document.getElementById('create-tour-desc').value);
    var imageCover = document.getElementById('create-image-cover').files[0];
    if (imageCover) {
      form.append('imageCover', imageCover);
    }
    var images = document.getElementById('create-images').files;
    if (images.length > 0) {
      for (var i = 0; i < images.length; i++) {
        form.append('images', images[i]);
      }
    }
    (0, _admin.createTour)(form);
  });
}
var closeBtns = document.querySelectorAll('.btn--close-modal-edit, .btn--close-modal-create');
if (closeBtns) {
  ...
  deleteReviewBtns.forEach(function (btn) {
    btn.addEventListener('click', function (e) {
      if (confirm('Delete this review?')) {
        (0, _admin.deleteReviewAdmin)(e.target.dataset.reviewId);
      }
    });
  });
}
var editReviewBtns = document.querySelectorAll('.btn--edit-review');
var modalReview = document.querySelector('.modal--edit-review');
var formEditReview = document.querySelector('.form--edit-review-admin');
var btnCloseReview = document.querySelector('.btn--close-modal-review');
if (editReviewBtns) {
  editReviewBtns.forEach(function (btn) {
    btn.addEventListener('click', function (e) {
      var _e$target$dataset4 = e.target.dataset,
        reviewId = _e$target$dataset4.reviewId,
        reviewText = _e$target$dataset4.reviewText,
        reviewRating = _e$target$dataset4.reviewRating;
...
if (btnCloseReview) {
  btnCloseReview.addEventListener('click', function () {
    return modalReview.classList.add('hidden');
  });
}
if (formEditReview) {
  formEditReview.addEventListener('submit', function (e) {
    e.preventDefault();
    var id = document.getElementById('admin-edit-review-id').value;
    var review = document.getElementById('admin-edit-text').value;
    var rating = document.getElementById('admin-edit-rating').value;
    (0, _admin.updateReviewAdmin)(id, {
      review: review,
      rating: rating
    });
  });
